...
if(isset($_POST['submit']))
{
	...
	$review=$_POST['review'];
	mysqli_query("insert into productreviews(productId,quality,price,value,name,summary,review) values('$pid','$qty','$price','$value','$name','$summary','$review')");
}
...
<div class="sidebar-widget hot-deals wow fadeInUp">
	...
	<div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-xs">
								   ...
								   <?php
$ret=mysqli_query($bd,"select * from products order by rand() limit 4 ");
