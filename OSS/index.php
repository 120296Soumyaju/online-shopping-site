...
<html lang="en">
	<head>
	    ...
	    <title>One For All Home Page</title>
...
?>
	...
	<div class="tab-pane" id="books">
		...
		<?php
$ret=mysqli_query($bd,"select * from products where category=3");
while ($row=mysqli_fetch_array($ret)) 
{
	# code...
	...
	<?php } ?>
		...
		<div class="tab-pane" id="furniture">
					<div class="product-slider">
						<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
		<?php
$ret=mysqli_query($bd,"select * from products where category=5");
while ($row=mysqli_fetch_array($ret)) 
{
?>
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Action Camera</h3>
	                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	   
<?php
$ret=mysqli_query($bd,"select * from products where category=7 and subCategory=14");
while ($row=mysqli_fetch_array($ret)) 
{
?>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Jacket</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
$ret=mysqli_query($bd,"select * from products where category=7 and subCategory=18");
while ($row=mysqli_fetch_array($ret)) 
{
?>
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Horns</h3>
		<div class="owl-carousel best-seller custom-carousel owl-theme outer-top-xs">
			<?php
$ret=mysqli_query($bd,"select * from products where category=8 and subCategory=22");
while ($row=mysqli_fetch_array($ret)) 
{
	# code...
