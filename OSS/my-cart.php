...
mysqli_query($bd,"insert into orders(userId,productId,quantity) values('".$_SESSION['id']."','$qty','$val34')");
...
$_SESSION['sid']=$pd;
						...
						<div class="row">
							...
							<div class="col-sm-8">
<?php $rt=mysqli_query($bd,"select * from productreviews where productId='$pd'");
		...
		<tbody>
				<tr>
					<td>
						...
						<?php $qry=mysqli_query($bd,"select * from users where id='".$_SESSION['id']."'");
