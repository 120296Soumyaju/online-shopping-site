...
$t1="23:59:59";
$to=date('Y-m-d')." ".$t1;
 $result = mysqli_query($bd,"SELECT * FROM Orders where orderDate Between '$from' and '$to'");
...
?>
									...
									<li>
										...
										<?php	
	$status='Delivered';									 
$ret = mysqli_query($bd,"SELECT * FROM Orders where orderStatus!='$status' || orderStatus is null ");
...
<?php } ?>
								...
								<?php	
	$status='Delivered';									 
$rt = mysqli_query($bd,"SELECT * FROM Orders where orderStatus='$status'");
