...
$ret=mysqli_query($bd,"select productImage1 from products where id='$pid'");
...
//unlink($dir.'/'.$pimage);
	...
	$sql=mysqli_query($bd,"update  products set productImage1='$productimage1' where id='$pid' ");
...
$query=mysqli_query($bd,"select productName,productImage1 from products where id='$pid'");
$cnt=1;
