...
$query=mysqli_query($bd,"insert into ordertrackhistory(orderId,status,remark) values('$oid','$status','$remark')");
$sql=mysqli_query($bd,"update orders set orderStatus='$status' where id='$oid'");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <?php 
$ret = mysqli_query($bd,"SELECT * FROM ordertrackhistory WHERE orderId='$oid'");
   ...
   <?php 
$st='Delivered';
   $rt = mysqli_query($bd,"SELECT * FROM orders WHERE id='$oid'");
