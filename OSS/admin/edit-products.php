...
if(isset($_POST['submit']))
{
	...
	$query=mysqli_query($bd,"select productName from products where id='pid'");
	$result=mysqli_fetch_row($query);
	$pname=$result['productName'];
	
rename("productimages/$pname","productimages/$productname");
$sql=mysqli_query($bd,"update  products set category='$category',subCategory='$subcat',productName='$productname',productCompany='$productcompany',productPrice='$productprice',productDescription='$productdescription',shippingCharge='$productscharge',productAvailability='$productavailability',productPriceBeforeDiscount='$productpricebd' where id='$pid' ");
...
$query=mysqli_query($bd,"select products.*,category.categoryName as catname,category.id as cid,subcategory.subcategory as subcatname,subcategory.id as subcatid from products 
